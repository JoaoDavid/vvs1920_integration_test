...
\section{Section}
In the $CustomerInfo.jsp$ file, I added the name "addresses" for the table element, so that I could get the table's information, when realizing the narrative A.
