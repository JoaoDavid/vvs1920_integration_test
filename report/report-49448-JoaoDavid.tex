...
\section{Section}
The name property was addded to some HTML elements, in order to be able to get them using HTML Unit:
In the $CustomerInfo.jsp$ file, the name "addresses" was for the table element.
In the $SalesInfo.jsp$ file, the name "sales" was for the table element.
